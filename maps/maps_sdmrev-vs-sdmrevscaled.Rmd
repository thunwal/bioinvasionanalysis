...
header-includes:
  ...
  \fancypagestyle{plain}{
    \fancyhf{}
    \fancyhead[L]{Notes on the effects of different cost raster input - reversed SDM vs. rescaled reversed SDM}
...
cost_surface_name <- "msculpturalis_sdm_clip_rev.tif"
cost_surface_name_2 <- "msculpturalis_sdm_clip_rev_scaled100.tif"
paths_gpkg <- "msculpturalis_20240106_sdmrev.gpkg" 
paths_gpkg_2 <- "msculpturalis_20240106_sdmrev100.gpkg" 
paths_layer_name <- "msculpturalis_20240106_sdmrev_paths"
...
# Notes on the effects of different cost raster input - reversed SDM vs. rescaled reversed SDM
...
The cost raster is a reversed version of the habitat suitability raster ("consensus map") published by [Lanner et al. (2022)](https://doi.org/10.1016/j.scitotenv.2022.154246), rescaled to a value range of 1-100.
